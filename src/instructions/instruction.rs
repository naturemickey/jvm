...
//        19 => Box::new(LDC_W {}),
//        20 => Box::new(LDC2_W {}),
        21 => Box::new(ILOAD::new(0)),
        22 => Box::new(LLOAD::new(0)),
        23 => Box::new(FLOAD::new(0)),
        24 => Box::new(DLOAD::new(0)),
        25 => Box::new(ALOAD::new(0)),
        26 => Box::new(ILOAD_0 {}),
        27 => Box::new(ILOAD_1 {}),
        28 => Box::new(ILOAD_2 {}),
        29 => Box::new(ILOAD_3 {}),
...
//        52 => Box::new(CALOAD {}),
//        53 => Box::new(SALOAD {}),
        54 => Box::new(ISTORE::new(0)),
        55 => Box::new(LSTORE::new(0)),
        56 => Box::new(FSTORE::new(0)),
        57 => Box::new(DSTORE::new(0)),
        58 => Box::new(ASTORE::new(0)),
        59 => Box::new(ISTORE_0 {}),
        60 => Box::new(ISTORE_1 {}),
        61 => Box::new(ISTORE_2 {}),
        62 => Box::new(ISTORE_3 {}),
...
//        191 => Box::new(ATHROW {}),
//        192 => Box::new(CHECK_CAST {}),
//        193 => Box::new(INSTANCE_OF {}),
